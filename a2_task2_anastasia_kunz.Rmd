...
```{r, fig.cap= "**Figure 2.** Boxplots comparing the average and distribution of tree height (left) and the number of green leaves (right) between two species of palmettos, *Serenoa repens* and *Sabal etonia*."}
...
palm_table <- tidy(palmetto_blr) %>% 
  mutate(p.value = case_when(p.value <= 0.0001 ~ "< 0.001"))
